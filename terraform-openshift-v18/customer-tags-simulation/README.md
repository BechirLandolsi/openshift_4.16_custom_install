...
```bash
# 1. Tag your subnets
./manual-tag-subnets.sh ../env/your-cluster.tfvars

# 2. Verify tags
./verify-manual-tags.sh ../env/your-cluster.tfvars

# 3. Lock tags (make immutable)
./lock-subnet-tags.sh ../env/your-cluster.tfvars
...
./cleanup-manual-tags.sh ../env/your-cluster.tfvars
```
...
```bash
# 1. Tag your subnets
./customer-tags-simulation/manual-tag-subnets.sh env/your-cluster.tfvars

# 2. Verify tags
./customer-tags-simulation/verify-manual-tags.sh env/your-cluster.tfvars

# 3. Lock tags (make immutable)
./customer-tags-simulation/lock-subnet-tags.sh env/your-cluster.tfvars
...
# 7. Clean up when done
./customer-tags-simulation/cleanup-manual-tags.sh env/your-cluster.tfvars
```
...
| Command | Purpose |
|---------|---------|
| `./manual-tag-subnets.sh ../env/your-cluster.tfvars` | Apply tags to subnets |
| `./verify-manual-tags.sh ../env/your-cluster.tfvars` | Check tags are correct |
| `./lock-subnet-tags.sh ../env/your-cluster.tfvars` | Make tags immutable |
| `./unlock-subnet-tags.sh ../env/your-cluster.tfvars` | Remove restrictions |
| `./monitor-tag-errors.sh 30` | Watch for tag errors (30 min) |
| `./cleanup-manual-tags.sh ../env/your-cluster.tfvars` | Full cleanup |
...
- Run scripts from this folder using relative paths: `./script.sh ../env/your-cluster.tfvars`
- Or run from parent: `./customer-tags-simulation/script.sh env/your-cluster.tfvars`
...
In parent directory:
- `env/your-cluster.tfvars` - Your configuration
