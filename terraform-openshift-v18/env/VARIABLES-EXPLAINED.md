...
# Filter for specific alias (replace with your alias name)
aws kms list-aliases --region eu-west-1 | grep "your-cluster"

# Output example:
# {
#   "Aliases": [
#     {
#       "AliasName": "alias/your-cluster-ec2-cmk",
...
```bash
# Describe specific key (replace with your alias)
aws kms describe-key \
  --key-id alias/your-cluster-ec2-cmk \
  --region eu-west-1
...
```hcl
# Use existing alias (replace with your alias)
kms_ec2_alias = "alias/your-cluster-ec2-cmk"
```
