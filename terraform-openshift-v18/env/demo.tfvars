...
#
# IMPORTANT: When you copy/rename this file:
#   1. Update the 'tfvars_file' variable below to match your new filename
#   2. Run: terraform apply -var-file=env/YOUR-FILE.tfvars
#
...
#   - tfvars_file      -> Path to your tfvars file (self-reference)
# ==============================================================================
...
# IMPORTANT: Path to this tfvars file (self-reference)
# This MUST match the filename you use with terraform apply -var-file=
# When you copy/rename this file, update this value accordingly!
